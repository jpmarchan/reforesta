   ...
   <table border="0" cellpadding="0" cellspacing="0" width="800px" align="center">
      ...
      <tr>
        <td style="background:#f7f9d4; padding: 65px; color: #3c342e; font-size:15px; padding-top: 45px; padding-bottom: 20px;">
          ...
          <br />
           <p style="font-size: 16px;"><b><i>GRACIAS POR SEMBRAR VIDA Y ESPERANZA</i></b></p>

          <p style="text-align: center; font-size: 16px;"> <a style="color:#3c342e;" href="https://reforesta.pe/<?php echo $urlCertificado; ?>"><b>Descarga el certificado de adopción de tu árbol aquí.</b></a></p>

          <p>Adoptar un árbol es una forma de devolver a la tierra una pequeña parte de todo lo que nos ha dado. Un árbol es hogar de especies, en torno a él, la vida se manifiesta de diversas formas. Y, en conjunto, forman maravillosos bosques que cumplen una importante función en el ecosistema.</p>
          ...
          <p> &nbsp; </p>
          <p style="text-align: right;">Para consultas, escríbenos a: <a href="mailto://reforesta@conservamos.org">reforesta@conservamos.org</a>.</a></p>
